...
public interface OpenALPR {
     ...
     */
    class Factory {
        public static final String TAG = OpenALPR.Factory.class.getSimpleName();
        ...
        public synchronized static OpenALPR create(Context context, String androidDataDir) {
            Log.i(TAG, "executeRecognition runtime_data: "+androidDataDir + File.separatorChar + "runtime_data");
            if (instance == null) {
