      ...
      <View style={styles.container}>
        ...
        <View style={styles.switch}>
          ...
          >
            <Picker.Item
              label="Low"
              value={Camera.constants.CaptureQuality.low}
            />
            <Picker.Item
              label="Medium"
              value={Camera.constants.CaptureQuality.medium}
            />
            <Picker.Item
              label="High"
              value={Camera.constants.CaptureQuality.high}
            />
          </Picker>
          ...
          >
            ...
            <Picker.Item
              label="Stretch"
              value={Camera.constants.Aspect.stretch}
            />
          </Picker>
        </View>
      </View>
